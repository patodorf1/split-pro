    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          'data-[vaul-drawer-direction=top]:rounded-b-card data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:border-b',
          'data-[vaul-drawer-direction=bottom]:rounded-t-card data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[80vh] data-[vaul-drawer-direction=bottom]:border-t',
            ...
            <DialogFooter className="mt-8 flex items-center gap-2">
              ...
              {actionTitle ? (
                !shouldCloseOnAction ? (
                  ...
                  <DialogClose
                    onClick={actionOnClick}
                    className="bg-primary text-primary-foreground w-[100px] rounded-md py-2 text-sm disabled:opacity-50"
                    disabled={actionDisabled}
                  >
                    {actionTitle}
                  </DialogClose>
