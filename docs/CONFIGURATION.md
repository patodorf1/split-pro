...
- `DEFAULT_HOMEPAGE`: Sets the landing page route after login, e.g. `/dashboard` (the home dashboard, default), `/balances` or `/groups`. `/home` is the public landing page and is redirected to `/dashboard` after login.
